...
public:
    ...
    {
        return _index.save(filename, prefault);
    };
    void unload()
    {
        _index.unload();
    ...
    {
        return _index.load(filename, prefault);
    };
    float get_distance(int32_t i, int32_t j) const
    {
        return _index.get_distance(i, j);
    };
    ...
    int32_t get_n_items() const
    {
        return _index.get_n_items();
    };
    int32_t get_n_trees() const
    {
    ...
    {
        return _index.on_disk_build(filename);
    };
};
